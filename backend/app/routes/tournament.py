...
# calculate_leaderboard moved (mechanically, unchanged) to
# app/services/tournament_legacy_scoring.py — re-exported here so existing
# `from app.routes.tournament import calculate_leaderboard` keeps working.
from app.services.tournament_legacy_scoring import calculate_leaderboard  # noqa: F401 (re-export)
